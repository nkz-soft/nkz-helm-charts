...
### Copied from the https://github.com/itscontained/charts/tree/master/itscontained/raw because the project does not seem to be supported anymore. At a least, the https://charts.itscontained.io repository is unavailable.
